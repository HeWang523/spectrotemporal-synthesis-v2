...
% cochleogram filters
if P.overcomplete==0 % 50% overlap
...
elseif P.overcomplete==1 % 75% overlap
    [audio_filts, audio_low_cutoff] = ...
        make_erb_cos_filts_double2(duration_sec*P.audio_sr, P.audio_sr, ...
        P.n_filts, P.lo_freq_hz, P.audio_sr/2, 'marmoset');
    
elseif P.overcomplete==2 % 87.5% overlap
    [audio_filts, audio_low_cutoff] = ...
...
% 
%     if 1 - corr_temp / corr <= 0.0015 && 1 - var_temp / var <= 0.0015
%         break;
%     end
% 
% 
